...
export const getCertifications = () => [
    {
        id: 1,
        title: 'Embedded Systems & Electronics Certificate',
        issuer: 'Technical Training',
        date: '2024',
        type: 'diploma',
        skills: ['PCB Design', 'Microcontroller', 'Embedded C', 'Circuit Design']
    },
    {
        id: 2,
        title: 'MATLAB for Engineering Applications',
        issuer: 'Applied Engineering',
        date: '2024',
        type: 'diploma',
    ...
    {
        id: 3,
        title: 'KiCad & Hardware Design Certification',
        issuer: 'Independent',
        date: '2023',
        type: 'course',
