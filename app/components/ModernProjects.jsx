...
const ModernProjects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      technologies: ['Flutter', 'Dart', 'Firebase', 'Figma', 'FireAuth'],
      category: 'mobile',
      liveUrl: 'https://github.com/soghayarmahmoud/wateera/releases/download/v1.0/wateera.apk',
    ...
    },
    {
      ...
      category: 'mobile',
      liveUrl:
        'https://github.com/soghayarmahmoud/notes/releases/download/v1.0/notes.apk',
      githubUrl: '',
      stars: '12',
      views: '2.1K',
      date: '2025',
    ...
    },
    {
      ...
      category: 'mobile',
      liveUrl:
        'https://github.com/soghayarmahmoud/buck/releases/download/v1.0/BuckaryApp.apk',
    ...
    },
    {
      ...
      category: 'mobile',
      liveUrl: 'https://github.com/soghayarmahmoud/oval/releases/download/v1.0/oval.apk',
