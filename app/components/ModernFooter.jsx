    ...
    <footer className="bg-[#0a0a0a] text-white">
      <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-12 grid gap-12 md:grid-cols-2 lg:grid-cols-4">
          <div className="lg:col-span-2">
            <div className="mb-6">
              <div className="mb-4 flex items-center gap-3">
                <div className="flex h-10 w-10 items-center justify-center rounded-2xl bg-amber-400 text-lg font-bold text-[#121212]">
                  ME
                </div>
            ...
            <div className="flex space-x-4">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-[#141414] text-[#f5f5f5] transition-colors hover:bg-amber-400 hover:text-[#121212]"
                >
                  {social.icon}
                </a>
              ))}
          ...
          <div>
            <h4 className="mb-6 text-xl font-bold text-amber-400">Quick Links</h4>
            <ul className="space-y-3">
              {quickLinks.map((link) => (
                <li key={link.name}>
                  <a
                    href={link.href}
                    className="text-[#d4d4d4] transition-colors hover:text-amber-300"
                  >
                    {link.name}
                  </a>
                </li>
          ...
          <div>
            <h4 className="mb-6 text-xl font-bold text-amber-400">Get in Touch</h4>
            <div className="space-y-4">
              <div>
                <p className="mb-1 text-sm font-semibold text-[#a3a3a3]">Email</p>
                <a href="mailto:mahmoudsruby@gmail.com" className="text-white transition-colors hover:text-amber-300">
                  mahmoudsruby@gmail.com
                </a>
              </div>
              <div>
                <p className="mb-1 text-sm font-semibold text-[#a3a3a3]">Phone</p>
                <a href="https://wa.me/201019593092" className="text-white transition-colors hover:text-amber-300">
                  +20 101 959 3092
                </a>
              </div>
              <div>
      ...
      <button
        onClick={scrollToTop}
        className="fixed bottom-8 right-8 flex h-12 w-12 items-center justify-center rounded-full bg-amber-400 text-[#121212] shadow-[0_15px_40px_rgba(245,158,11,0.25)] transition-colors hover:bg-amber-300"
      >
        <ArrowUp size={24} />
      </button>
    </footer>
