      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            <p className="mb-4 text-xs font-semibold uppercase tracking-[0.32em] text-amber-400">Reviews</p>
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-white">
              Share Your Experience
            </h2>
            <div className="mx-auto mb-8 h-px w-20 rounded-full bg-gradient-to-r from-transparent via-amber-400 to-transparent"></div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full rounded-lg border border-white/10 bg-[#0e0e0e] px-4 py-3 text-[#f5f5f5] placeholder:text-[#a3a3a3] transition-colors focus:border-amber-400 focus:outline-none"
                ...
                <div>
                  ...
                  <select
                    ...
                    onChange={handleInputChange}
                    required
                    className="w-full rounded-lg border border-white/10 bg-[#0e0e0e] px-4 py-3 text-[#f5f5f5] transition-colors focus:border-amber-400 focus:outline-none"
                  >
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows={5}
                    className="w-full resize-none rounded-lg border border-white/10 bg-[#0e0e0e] px-4 py-3 text-[#f5f5f5] placeholder:text-[#a3a3a3] transition-colors focus:border-amber-400 focus:outline-none"
                ...
                <button
                  ...
                  className="flex w-full items-center justify-center gap-2 rounded-full bg-amber-400 px-6 py-3 font-semibold text-[#121212] transition-colors hover:bg-amber-300 disabled:opacity-70 shadow-[0_12px_30px_rgba(245,158,11,0.2)]"
                >
                  {isSubmitting ? (
                    <>
            ...
            <motion.div
              ...
              className="space-y-8"
            >
              <div className="rounded-[26px] border border-amber-400/20 bg-[#121212] p-8">
