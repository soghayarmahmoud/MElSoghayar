      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            <p className="mb-4 text-xs font-semibold uppercase tracking-[0.32em] text-amber-400">Services</p>
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                >
                  ...
                  <div className="flex h-11 w-11 items-center justify-center rounded-full border border-white/10 bg-[#1a1a1a] text-2xl text-amber-400">
                    {index === currentIndex ? '−' : '+'}
                  </div>
                </button>
